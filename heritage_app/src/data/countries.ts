...
export const COUNTRIES: CountryInfo[] = [
    ...
    { name: "Cayman Islands", region: "Americas" },
    ...
    { name: "Congo (Kinshasa)", region: "Africa" },
    ...
    { name: "Greenland", region: "Americas" },
    { name: "Grenada", region: "Americas" },
    { name: "Guadeloupe", region: "Americas" },
    ...
    { name: "Heard & McDonald Islands", region: "Oceania" },
    ...
    { name: "Martinique", region: "Americas" },
    ...
    { name: "Montserrat", region: "Americas" },
    ...
    { name: "Pitcairn", region: "Oceania" },
    { name: "Poland", region: "Europe" },
    { name: "Portugal", region: "Europe" },
    { name: "Puerto Rico", region: "Americas" },
    ...
    { name: "Saint Barthélemy", region: "Americas" },
    { name: "Saint Helena", region: "Africa" },
    { name: "Saint Kitts and Nevis", region: "Americas" },
    { name: "Saint Lucia", region: "Americas" },
    { name: "Saint Martin", region: "Americas" },
    { name: "Saint Pierre and Miquelon", region: "Americas" },
    ...
    { name: "Sint Maarten", region: "Americas" },
    ...
    { name: "South Georgia & Sandwich Islands", region: "Americas" },
    ...
    { name: "Turks and Caicos Islands", region: "Americas" },
    ...
    { name: "United States Minor Outlying Islands", region: "Oceania" },
    ...
    { name: "Virgin Islands (British)", region: "Americas" },
    { name: "Virgin Islands (U.S.)", region: "Americas" },
...
export const getRegionForCountry = (countryName: string): string => {
    ...
    return country ? country.region : 'Unknown Region';
};
